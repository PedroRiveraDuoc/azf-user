...
public class OracleDBConnection {
    ...
    public static boolean testConnection() {
        try (Connection conn = getConnection()) {
            ...
            logger.info("Conexión a Oracle probada: " + (isValid ? "VÁLIDA" : "INVÁLIDA"));
            return isValid;
    ...
    public static Connection getConnection() throws SQLException {
        ...
        String tnsName = System.getenv("ORACLE_TNS_NAME");               // yq95nd3x7bhk88dg_high
        String user = System.getenv("ORACLE_USER");                      // back_vet
        String password = System.getenv("ORACLE_PASSWORD");              // Zm10ghasduoc
        String walletPath = System.getenv("ORACLE_WALLET_PATH");        // /wallet (local) o /home/site/wwwroot/wallet (Azure)
